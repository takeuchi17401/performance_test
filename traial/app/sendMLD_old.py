...
class SimpleMonitor(simple_switch_13.SimpleSwitch13):
    ...
    def add_flow(self, datapath, priority, match, actions):
        ...
        # match
        match = ofproto_v1_3_parser.OFPMatch(eth_type=ether.ETH_TYPE_IPV6, ip_proto=inet.IPPROTO_ICMPV6)
        # miss match
        ...
        if self.PROTPCOL in 'ipv6':
            ...
            if 0 < len(pkt_icmpv6):
                ...
                if pkt_icmpv6[0].type_ != icmpv6.ND_NEIGHBOR_SOLICIT:
                    self._handle_icmp(datapath, in_port, pkt_eth, pkt_ipv6[0], pkt_icmpv6[0])
                    return
